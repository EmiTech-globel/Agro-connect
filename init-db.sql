...
('Oil Mill Market', 'Rivers', 'South South', 'wholesale'),
('New Benin Market', 'Edo', 'South South', 'retail'),
('Onitsha Main Market', 'Anambra', 'South East', 'wholesale'),
('Terminus Market', 'Plateau', 'North Central', 'retail'),
('Port Harcourt Market', 'Rivers', 'South South', 'wholesale'),
('Obio-Akpor Market', 'Rivers', 'South South', 'retail'),
('Shomolu Market', 'Lagos', 'South West', 'retail'),
('Ajah Market', 'Lagos', 'South West', 'retail'),
('Agege Market', 'Lagos', 'South West', 'retail'),
('Kosofe Market', 'Lagos', 'South West', 'retail'),
('Mushin Market', 'Lagos', 'South West', 'retail'),
('Ilorin West Market', 'Kwara', 'North Central', 'retail'),
('Karu Market', 'FCT', 'North Central', 'retail'),
('Maiduguri Market', 'Borno', 'North East', 'retail'),
('Ojo Market', 'Lagos', 'South West', 'retail'),
('Ikorodu Market', 'Lagos', 'South West', 'retail'),
('Lagos Island (Eko) Market', 'Lagos', 'South West', 'retail'),
('Dei-Dei Market', 'FCT', 'North Central', 'retail'),
('Apo District Market', 'FCT', 'North Central', 'retail'),
('Oju Market', 'Benue', 'North Central', 'retail'),
('Warri Market', 'Delta', 'South South', 'wholesale'),
('Abakaliki Market', 'Ebonyi', 'South East', 'retail'),
('Obi-Nasarawa Market', 'Nasarawa', 'North Central', 'retail'),
('Ado-Odo/Ota Market', 'Ogun', 'South West', 'retail'),
('Ipaja Market', 'Lagos', 'South West', 'retail'),
('Kubwa Market', 'FCT', 'North Central', 'retail'),
('Ede Market', 'Osun', 'South West', 'retail'),
('Ilorin South Market', 'Kwara', 'North Central', 'retail'),
('Sagamu Market', 'Ogun', 'South West', 'retail');
